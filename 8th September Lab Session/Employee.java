...
public class Employee{ //Employee class created
	public static void main(String... arg) { //Method declaration
...
class Employee_info{ //Creating another class
	static void details(String emp_name, int emp_ID) { //Declaring Method
	System.out.println("The employee name is: " + emp_name + ", The employee ID is: " + emp_ID); //Print statement	
	}}
